  ...
  where
    runner = do
      ...
      usingReaderT testEnv $ appendTestDirM "deleteUnknownError" $ do
        ...
        captureCharonExceptionTermBS @PathNotFound testDir argList
  ...
  where
    runner = do
      ...
      usingReaderT testEnv $ appendTestDirM "deletesSome" $ do
        ...
        term <- captureCharonExceptionTermBS @PathNotFound testDir argList

        -- trash structure assertions
        assertFdoDirectorySizesM []
        indexMeta <- captureIndex testDir
  ...
  where
    runner = do
      ...
      usingReaderT testEnv $ appendTestDirM "deleteEmptyError" $ do
        ...
        -- trash structure assertions
        bs <- captureCharonExceptionTermBS @EmptyPathE testDir argList
        assertFdoDirectorySizesM []
        pure bs
  ...
  where
    runner = do
      ...
      usingReaderT testEnv $ appendTestDirM "deleteDotsError" $ do
        ...
        bs <- captureCharonExceptionTermBS @DotsPathE testDir argList
        assertFdoDirectorySizesM []
        pure bs
