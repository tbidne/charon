  ...
  where
    runner = do
      ...
      usingReaderT testEnv $ appendTestDirM "noPathsError" $ do
        ...
        captureCharonExceptionTermBS @TrashDirFilesNotFoundE testDir argList
  ...
  where
    runner = do
      ...
      usingReaderT testEnv $ appendTestDirM "noInfoError" $ do
        ...
        captureCharonExceptionTermBS @TrashDirInfoNotFoundE testDir argList
  ...
  where
    runner = do
      ...
      usingReaderT testEnv $ appendTestDirM "missingPathError" $ do
        ...
        captureCharonExceptionTermBS @TrashEntryFileNotFoundE testDir listArgList
  ...
  where
    runner = do
      ...
      usingReaderT testEnv $ appendTestDirM "missingInfoError" $ do
        ...
        captureCharonExceptionTermBS @TrashEntryInfoNotFoundE testDir argList
