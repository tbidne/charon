...
module Unit.Backend.Cbor.PathData
  ( tests,
  )
where

import Charon.Backend.Cbor.PathData (PathData (UnsafePathData))
import Charon.Backend.Cbor.PathData qualified as Cbor
